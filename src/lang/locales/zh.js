...
module.exports = {
     ...
     * */
    "menu.dashboards": "报告",
    "menu.product.page":"商品",
    "menu.product.list":"产品列表",
    "menu.product.create":"创造产品",
    "menu.product.stockmanager":"存货管理",
    "menu.product.category":"产品类别",
    "menu.library.image":"图片",
    "menu.library.image.web":"网站图片",
    "menu.library.image.product":"产品图片",
    "menu.order":"单子",
    "menu.order.list":"单子列表",
    "menu.order.create":"创造单子",
    "menu.order.create.purchese":"存货单",
    "menu.post":"产品描述",
    "menu.post.create":"创造描述",
    "menu.post.edit":"修理描述",
    "menu.post.list":"描述列表",
    "menu.user":"会员",
    "menu.user.list":"会员列表",
    "menu.user.create":"创造会员",
    "menu.user.edit":"修理会员",
    "menu.setting":"设置",
    "menu.setting.banner":"横幅设置",
    "menu.setting.banner.create":"创造横幅",
    "menu.setting.slide":"滑动设置",
    "menu.setting.slide.create":"创造滑动",
    "menu.setting.slide.form.title":"产品名字",
    "menu.setting.slide.form.description":"产品描述",
    "menu.setting.slide.form.price":"价格",
    "menu.setting.slide.form.thumbnail":"产品图片",
    "menu.setting.slide.form.href":"产品链接",
    "menu.setting.menu":"菜单设置",
    "menu.setting.website":"网站设置",
    /**
     * product form
     * */
    "product.list":"产品列表",
    "product.form.name":"产品名字",
    "product.form.category.list":"分类目录",
    "product.form.category.select":"挑选分类目录",
    "product.form.category.default":"分类目录默认",
    "product.form.content":"产品内容",
    "product.form.info":"产品信息",
    "product.form.nameVi":"越南产品名字",
    "product.form.nameZh":"中国产品名字",
    "product.form.skuVi":"越南货号",
    "product.form.skuZh":"中国货号",
    "product.form.thumbnail":"产品图片",
    "product.form.conditiondefault":"零售状况",
    "product.form.condition1":"VIP1状况",
    "product.form.condition2":"VIP2状况",
    "product.form.condition3":"VIP3状况",
    "product.form.condition4":"VIP4状况",
    "product.form.gallery":"画廊",
    "product.form.action":"操纵",
    "product.form.variant.info":"变体信息",
    "product.form.variant.name":"变体名字",
    "product.form.variant.nameZh":"中国变体名字",
    "product.form.variant.skuZh":"变体货号",
    "product.form.variant.sku":"变体货号",
    "product.form.variant.barcodeVariant":"二维码",
    "product.form.variant.thumbnail":"变体图片",
    "product.form.variant.stock":"可售量",
    "product.form.variant.dimension":"尺码",
    "product.form.variant.lenght":"长度",
    "product.form.variant.width":"宽度",
    "product.form.variant.height":"高度",
    "product.form.variant.weight":"重量",
    "product.form.variant.priceZh":"原价",
    "product.form.variant.pricedefault":"零售价",
    "product.form.variant.vip1":"VI1价",
    "product.form.variant.vip2":"VI2价",
    "product.form.variant.vip3":"VI3价",
    "product.form.variant.vip4":"VI4价",
    "button.update":"更新",
    "button.media":"加媒体",
    /**
     * category
    ...
    "category.list":"类别列表",
    "category.create":"创造类别",
    "category.name":"类别名字",
    "category.sku":"类别号码",
    "category.rate":"汇价",
    "category.factorDefault":"零售因素",
    "category.factor1":"VIP1因素",
    "category.factor2":"VIP2因素",
    "category.factor3":"VIP3因素",
    "category.factor4":"VIP4因素",
    "category.parent":"父母类别",
    "category.conditionPurchse":"状况",
    "category.btn.remove":"删除类别",
    "category.btn.edit":"修理类别",
    "category.btn.action":"操纵",
     ...
     * Setting
     * */
    "setting.website.form":"网站信息",
    "setting.website.form.name":"网站名字",
    "setting.website.form.phoneNumber":"电话号码",
    "setting.website.form.address":"地址",
    "setting.website.form.logo":"商标",
    "setting.website.form.email":"邮件",
    /* 01.General */
    ...
    /* 04.Dashboards */
    "dashboards.pending-orders": "Đơn hàng đang xử lý",
