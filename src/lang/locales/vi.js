...
export default {
     ...
     * search
     * */
    "search.input":"Nhập vào từ khóa tìm kiếm",
    "button.search":"Tìm kiếm",
    /**
     *
     * */
    "menu.dashboards": "Báo cáo",
    "menu.product.page":"Sản phẩm",
    "menu.product.list":"Danh sách sản phẩm",
    "menu.product.create":"Tạo sản phẩm",
    "menu.product.stockmanager":"Quản lý tồn kho",
    "menu.product.category":"Chuyên mục sản phẩm",
    "menu.library.image":"Thư viện hình ảnh",
    "menu.library.image.web":"Hình ảnh web",
    "menu.library.image.product":"Hình ảnh Sản phẩm",
    "menu.library.icons":"Icons",
    "menu.order":"Đơn hàng",
    "menu.order.list":"Danh sách đơn hàng",
    "menu.order.create":"Tạo đơn hàng",
    "menu.order.cart_list":"Danh sách giỏ hàng",
    "menu.order.create.purchese":"Đơn hàng nhập kho",
    "menu.post":"Bài viết",
    "menu.post.create":"Tạo bài viết",
    "menu.post.edit":"Sửa bài viết",
    "menu.post.list":"Danh sách bài viết",
    "menu.delivery":"Website vận chuyển",
    "menu.delivery.form.delivery":"Form vận chuyển",
    "menu.delivery.form.order":"Form đặt hàng",
    "menu.delivery.form.currencyconversion":"Form đổi tiền",
    "menu.delivery.setting.content":"Cài đặt nội dung",
    "menu.delivery.setting.seo":"Cài đặt seo",
    "menu.delivery.setting.menu":"Cài đặt menu",
    "menu.user":"Thành viên",
    "menu.user.list":"Danh sách thành viên",
    "menu.user.create":"Tạo thành viên",
    "menu.user.edit":"Chỉnh sửa thành viên",
    "menu.setting":"Cài đặt",
    "menu.setting.banner1":"Cài đặt banner 1",
    "menu.setting.banner2":"Cài đặt banner 2",
    "menu.setting.banner.create":"Tạo banner",
    "menu.setting.slide":"Cài đặt slide",
    "menu.setting.slide.create":"Tạo slide",
    "menu.setting.slide.form.title":"Tên sản phẩm",
    "menu.setting.slide.form.description":"Mô tả sản phẩm",
    "menu.setting.slide.form.price":"Giá sản phẩm",
    "menu.setting.slide.form.thumbnail":"Hình sản phẩm",
    "menu.setting.slide.form.href":"Link sản phẩm",
    "menu.setting.menu":"Cài đặt menu",
    "menu.setting.website":"Cài đặt website",
    "menu.setting.price":"Cài đặt giá",
    "menu.setting.ship":"Cài đặt phí vận chuyển",
    "menu.setting.brand":"Cài đặt thương hiệu",
    "menu.setting.embed":"Nhúng Header",
    "menu.setting.social":"Nhúng Social",
    "menu.setting.robots":"Cài đặt file robots.txt",
    "menu.setting.price.condition1":"Mức giá điều kiện 1",
    "menu.setting.price.condition2":"Mức giá điều kiện 2",
    "menu.setting.price.condition3":"Mức giá điều kiện 3",
    "menu.setting.price.retailt":"Mức giá bán lẻ",
    "menu.setting.geo2ip":"Chặn các quốc gia",
    "menu.partner":"Đối tác",
    "menu.partner.list":"Danh sách đối tác",
    "menu.ghn":"Giao hàng nhanh",
    "menu.ghn.setting":"Cài đặt",
    "menu.ghn.order":"Hóa đơn",
    "menu.lazada":"Lazada",
    "menu.lazada.setting":"Cài đặt lazada",
    "menu.lazada.list":"Danh sách sản phẩm",
    "menu.lazada.detail":"Chi tiết sản phẩm",
    /**
     * product form
     * */
    "product.list":"Danh sách sản phẩm",
    "product.form.name":"Tên sản phẩm",
    "product.form.nameZh":"Tên sản phẩm TQ",
    "product.form.category.list":"Chuyên mục",
    "product.form.category.select":"Chọn chuyên mục sản phẩm",
    "product.form.category.default":"Chuyên mục mặt định",
    "product.form.content":"Nội dung sản phẩm",
    "product.form.info":"Thông tin sản phẩm",
    "product.form.nameVi":"Tên sản phẩm VN",
    "product.form.skuVi":"Mã sản phẩm VN",
    "product.form.skuZh":"Mã sản phẩm TQ",
    "product.form.thumbnail":"Hình ảnh sản phẩm",
    "product.form.conditiondefault":"Điều kiện bán lẻ",
    "product.form.condition1":"Điều kiện bán vip 1",
    "product.form.condition2":"Điều kiện bán vip 2",
    "product.form.condition3":"Điều kiện bán vip 3",
    "product.form.condition4":"Điều kiện bán vip 4",
    "product.form.gallery":"Bộ sưu tập",
    "product.form.action":"Thao tác",
    "product.form.variant.info":"Thông tin biến thể",
    "product.form.variant.name":"Tên biến thể",
    "product.form.variant.nameZh":"Tên biến thể TQ",
    "product.form.variant.skuZh":"Mã biến thể",
    "product.form.variant.sku":"Mã biến thể",
    "product.form.variant.barcodeVariant":"Mã vạch",
    "product.form.variant.thumbnail":"Hình ảnh biến thể",
    "product.form.variant.stock":"Tồn kho",
    "product.form.variant.dimension":"Kích thước",
    "product.form.variant.lenght":"Chiều dài",
    "product.form.variant.width":"Chiều rộng",
    "product.form.variant.height":"Chiều cao",
    "product.form.variant.weight":"Khối lượng",
    "product.form.variant.priceZh":"Giá TQ",
    "product.form.variant.pricedefault":"Giá bán lẻ",
    "product.form.variant.vip1":"Giá bán vip1",
    "product.form.variant.vip2":"Giá bán vip2",
    "product.form.variant.vip3":"Giá bán vip3",
    "product.form.variant.vip4":"Giá bán vip4",
    "product.form.material":"Chất liệu sản phẩm",
    "product.form.averageweight":"Trọng lượng trung bình",
    "product.form.description":"Mô tả",
    "button.update":"Cập nhật",
    "button.media":"Thêm media",
    /**
     * category
     * */
    ...
    "category.sku":"Mã chuyên mục",
    "category.rate":"Tỷ giá",
    "category.factorDefault":"Hệ số bán lẻ",
    "category.factor1":"Hệ số chuyển vip 1",
    "category.factor2":"Hệ số chuyển vip 2",
    "category.factor3":"Hệ số chuyển vip 3",
    "category.factor4":"Hệ số chuyển vip 4",
    "category.parent":"Chọn chuyên mục cha",
    "category.conditionPurchse":"Điều kiện bán hàng",
    "category.btn.remove":"Xóa chuyên mục",
    "category.btn.edit":"Sửa chuyên mục",
    "category.btn.action":"Thao tác",
    ...
    "order.address.province":"Thành phố",
    "order.address.dictrict":"Quận/Huyện",
    "order.address.ward":"Xã/Phường",
    "order.address.address":"Địa chỉ",
    "order.action.trash":"Chuyển vào thùng rác",
    "order.action.remove":"Xóa",
    "order.action.print":"In hóa đơn",
    "order.action.printwithoutprice":"Xóa",
    "order.action.pendding":"Chuyển vào thùng rác",
    "order.action.cancel":"Chuyển vào thùng rác",
    "order.action.success":"Chuyển vào thùng rác",
    "order.action.processing":"Chuyển vào thùng rác",
    "order.action.failed":"Chuyển vào thùng rác",
    "order.action.shipping":"Chuyển vào thùng rác",
    "order.action.awaitingadditionaldelivery":"Chuyển vào thùng rác",
    "order.action.partiallypaid":"Chuyển vào thùng rác",
    "order.action.paid":"Chuyển vào thùng rác",
    "order.action.refunded":"Chuyển vào thùng rác",


    /**
     * image
     * */
    "image.action":"Thao tác",
    "image.upload":"Tải ảnh lên",
    "image.delete":"Xóa",
    "image.uploadmulti":"Tải ảnh lên nhiều",
    /**
     * Extention
     * */
    "extention.menu":"Cào dữ liệu",
    "extention.shop":"Danh sách shop",
    "extention.products":"Danh sách sản phẩm",
    "extention.detailt":"Chi tiết sản phẩm",
    "extention.log":"Xem lỗi",
    "extention.cart":"Giỏ hàng 1688",
    "extention.dictionary":"Bộ từ điển",
    /** ChatGPT
     *
     */
    "chatgpt.setting":"Cài đặt tài khoản",
    "chatgpt.log":"ChatGPT LOG",
    /**
     * Setting
     * */
    "setting.website.form":"Thông tin website",
    "setting.website.form.name":"Tên website",
    "setting.website.form.phoneNumber":"Số điện thoại",
    "setting.website.form.address":"Địa chỉ",
    "setting.website.form.logo":"Logo",
    "setting.website.form.email":"Email",
    "menu.setting.email":"Cài đặt email",
    /**
     * Log
     * */
    "menu.log":"Xem lỗi",
    ...
    "menu.facebook.setting":"Cài đặt",
    "menu.facebook.categories":"Danh sách chuyên mục",
    "menu.facebook.uploaded":"Sản phẩm đã up",
    /* 01.General */
    ...
    /* 04.Dashboards */
    "dashboards.curentCost": "Chi phí tháng này",
    "dashboards.curentPackage": "Số kiện tháng này",

    "dashboards.pending-orders": "Đang xử lý",
    "dashboards.completed-orders": "Hoàn thành",
    "dashboards.shipping-orders": "Đang vận chuyển",
    "dashboards.processing-orders": "Chờ thanh toán",
    "dashboards.paid-orders": "Đã thanh toán",
    "dashboards.partiallypaid-orders": "Thanh toán một phần",
